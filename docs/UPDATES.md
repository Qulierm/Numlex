...
**4.8.0 was the first updater-enabled release; 4.9.1 is the current one.**

- Users on **4.7.0 or earlier have no updater**: install the current release
  (4.9.1) manually once from the released `.dmg`, exactly as before. Those
...
- **4.8.0 and later update in-app** with the flow above (4.8.0 itself sees and
  installs 4.9.1).
- The published feed advertises the current release (4.9.1 as of this
