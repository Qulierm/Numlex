...
упакованный ресурс `NumlexTax/tax-presets.json` (версия `tax-presets-2026.1`,
SHA-256 в манифесте, fail-closed): AU GST 10, GB VAT 20, DE VAT 19,
NL VAT 21 и другие. У `US` автоматической ставки НЕТ (`ratePercent: null`,
...
`taxPeriod`: US `2026`, GB `2026/27`, DE `2026`, FR `2026 (income 2025)`,
NL `2026`, JP `2026` (ставки NTA актуальны на 01.04.2026), RU `2026`;
AU `2025-26`, CA `2025`, IN `AY 2026-27 (FY 2025-26)` — для этих трёх
официальное расписание на 2026 год не подтверждено на момент снимка, и они
помечены блокерами (никогда не переименовываются в 2026). Модель: грубая
национальная оценка —
