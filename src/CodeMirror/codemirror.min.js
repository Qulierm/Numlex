!(function (e, t) {
	...
	var ge = [],
		me = function (e, t, n) {
			e.addEventListener
				...
				: ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || ge).concat(n))
		}
	function ve(e, t) {
					...
					for (var i = 0; i < e.length; ++i) {
						...
						;(!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) &&
							...
							((o =
								null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)),
							(r = r || []).push(
								new Lt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)
							))
					}
				return r
			})(r, o, e),
	...
	function Ln(e, t) {
		...
		o && !o.text
			? (o = null)
			: o && o.changes && (ln(e, o, i, $n(e)), (e.curOp.forceUpdate = !0)),
			o ||
				((n = e),
				(e = Ze((r = It((r = t))))),
	...
	function zn(e, t) {
		var n = 0
		;(t = at(e.doc, t)), e.options.lineWrapping || (n = _n(e.display) * t.ch)
	...
	function Jn(e, t, n, r) {
		...
		return (
			r &&
				...
				(s = tt(
					s.line,
					Math.max(0, Math.round((o - vn(e.display).left) / _n(e.display)) - l)
				))),
			s
		)
	}
	...
	function ar(e, t, n) {
		...
		;(i.style.left = r.left + 'px'),
			...
			!/\bcm-fat-cursor\b/.test(e.getWrapperElement().className) ||
				(0 < (t = In(e, t, 'div', null, null)).right - t.left &&
					(i.style.width = t.right - t.left + 'px')),
			r.other &&
				(((n = n.appendChild(
		...
		for (
			...
			if (!a.hidden) {
					...
					w && v < 8
						...
						: ((c = (d = a.node.getBoundingClientRect()).bottom - d.top),
						  !u &&
								a.text.firstChild &&
								(h =
									a.text.firstChild.getBoundingClientRect().right - d.left - 1))
				...
				h > e.display.sizerWidth &&
					(h = Math.ceil(h / _n(e.display))) > e.display.maxLineLength &&
	...
	function ri(e, t) {
		var n = ti(t),
			...
			i = n.y,
			o = ei
		0 === event.deltaMode && ((r = t.deltaX), (i = t.deltaY), (o = 1))
		var l = e.display,
			s = l.scroller,
	...
	function gi(e, o, t, l) {
		...
		o.full
			...
			? 1 == c.length
				...
				: ((s = r(1, c.length - 1)).push(new Kt(f + h.text.slice(u.ch), p, l)),
	...
	function wi(e, t) {
		var n = { from: it(t.from), to: ai(t), text: _e(e, t.from, t.to) }
		return (
	...
	function Ei(e, t, n) {
		...
		var o =
			(n && n.bias) || (nt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1)
		Ii(e, zi(e, t, o, !0)),
			(n && !1 === n.scroll) ||
				!e.cm ||
	...
	;(ho.prototype = q(no.prototype, {
		...
		getSelection: function (e) {
			for (var t = this.sel.ranges, n = 0; n < t.length; n++)
				var r = _e(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r
	...
	function dl(e, t, n, r) {
		...
		if ((d < c && (h += X(c - d)), h != u))
			return (
				qi(o, h, tt(t, 0), tt(t, u.length), '+input'), !(s.stateAfter = null)
			)
		...
		(e.prototype.pollContent = function () {
			...
			for (
				var s = t.doc.splitLines(
					...
					a = _e(t.doc, tt(e, 0), tt(o, Ye(t.doc, o).text.length));
	...
	;(r.prototype.init = function (n) {
		...
		function t(e) {
			if (!we(i, e)) {
				if (i.somethingSelected()) pl({ lineWise: !1, text: i.getSelections() })
				else {
