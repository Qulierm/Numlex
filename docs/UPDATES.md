...
**4.8.0 was the first updater-enabled release; 4.9.5 is the current one.**

- Users on **4.7.0 or earlier have no updater**: install the current release
  (4.9.5) manually once from the released `.dmg`, exactly as before. Those
...
- **4.8.0 and later update in-app** with the flow above (4.8.0 itself sees and
  installs 4.9.5).
- The published feed advertises the current release (4.9.5 as of this
