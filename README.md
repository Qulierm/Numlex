...
settings reference: one fixed category sidebar (General, Editing, Numbers,
Constants & Units, Styling, About) with one focused detail page each —
...
The engine suite covers 1,080 shared cases, runnable two ways:
