...
import Foundation
let allCases = engineCases + sheetCases + syntaxCases + formatCases + settingsCases + caretCases + baselineCases + spaceTypingCases + conversionCases + deletionCases + overflowCases + answerReferenceCases + unitCatalogCases + richConversionCases + rateTableCases + rateServiceCases + moneyCases + dateCases + moneyAssignmentCases + r18Cases + r18FormatCases + r18AnimationCases + r19OperatorCases + r19GroupCases + r19PrevAnswerCases + r19IdentityCases + r19SettingsCases + r19RefFixCases + windowGeometryCases + stylingCases + syntaxRoleCases + r32Cases + r33Cases + r35Cases + r37Cases + r38Cases + r39Cases + r40Cases + r41Cases + r43Cases + r44Cases + r47Cases + r51Cases + glassToneCases + r53Cases + r54Cases + r55Cases + r56Cases + r57Cases + r58Cases + r59Cases + r61Cases + r62Cases + r73Cases + r77MotionCases + r80Cases + r82Cases + r83Cases + r84Cases + r85Cases + r87Cases + r88Cases + r89Cases + footerTotalCases + currencyCases + updateCases
var failures = 0
